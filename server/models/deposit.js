...
DepositSchema.statics = {
    ...
    load: function(options, cb) {
        options.select = options.select || Object.keys(DepositSchema.paths).join(' ');
    ...
    list: function(options, cb) {
        ...
        const select = options.select || Object.keys(DepositSchema.paths).join(' ');
