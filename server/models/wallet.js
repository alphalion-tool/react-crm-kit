...
WalletSchema.statics = {
    ...
    load: function(options, cb) {
        options.select = options.select || Object.keys(WalletSchema.paths).join(' ');
    ...
    list: function(options, cb) {
        ...
        const select = options.select || Object.keys(WalletSchema.paths).join(' ');
